 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Sh(e){bn(new De("platform-logger",t=>new Fu(t),"PRIVATE")),bn(new De("heartbeat",t=>new Ih(t),"PRIVATE")),zt(Ps,pr,e),zt(Ps,pr,"esm2017"),zt("fire-js","")}Sh("");var Ch="firebase",_h="9.18.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function I(e="Unexpected state"){const t=`FIRESTORE (${de}) INTERNAL ASSERTION FAILED: `+e;throw mt(t),new Error(t)}function R(e,t){e||I()}function S(e,t){return e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Z{constructor(t){this.binaryString=t}static fromBase64String(t){const n=function(s){try{return atob(s)}catch(i){throw i instanceof DOMException?new zl("Invalid base64 string: "+i):i}}(t);return new Z(n)}static fromUint8Array(t){const n=function(s){let i="";for(let r=0;r<s.length;++r)i+=String.fromCharCode(s[r]);return i}(t);return new Z(n)}[Symbol.iterator](){let t=0;return{next:()=>t<this.binaryString.length?{value:this.binaryString.charCodeAt(t++),done:!1}:{value:void 0,done:!0}}}toBase64(){return t=this.binaryString,btoa(t);var t}toUint8Array(){return function(t){const n=new Uint8Array(t.length);for(let s=0;s<t.length;s++)n[s]=t.charCodeAt(s);return n}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(t){return k(this.binaryString,t.binaryString)}isEqual(t){return this.binaryString===t.binaryString}}Z.EMPTY_BYTE_STRING=new Z("");const Gl=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function St(e){if(R(!!e),typeof e=="string"){let t=0;const n=Gl.exec(e);if(R(!!n),n[1]){let i=n[1];i=(i+"000000000").substr(0,9),t=Number(i)}const s=new Date(e);return{seconds:Math.floor(s.getTime()/1e3),nanos:t}}return{seconds:L(e.seconds),nanos:L(e.nanos)}}function L(e){return typeof e=="number"?e:typeof e=="string"?Number(e):0}function Zt(e){return typeof e=="string"?Z.fromBase64String(e):Z.fromUint8Array(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Oa(e){var t,n;return((n=(((t=e==null?void 0:e.mapValue)===null||t===void 0?void 0:t.fields)||{}).__type__)===null||n===void 0?void 0:n.stringValue)==="server_timestamp"}function La(e){const t=e.mapValue.fields.__previous_value__;return Oa(t)?La(t):t}function Fe(e){const t=St(e.mapValue.fields.__local_write_time__.timestampValue);return new P(t.seconds,t.nanos)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Se{constructor(t,n="asc"){this.field=t,this.dir=n}}function sd(e,t){return e.dir===t.dir&&e.field.isEqual(t.field)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class If{constructor(t,n,s,i,r){this.localStore=t,this.datastore=n,this.asyncQueue=s,this.remoteSyncer={},this._u=[],this.wu=new Map,this.mu=new Set,this.gu=[],this.yu=r,this.yu.Gr(o=>{s.enqueueAndForget(async()=>{jt(this)&&(v("RemoteStore","Restarting streams for network reachability change."),await async function(a){const c=S(a);c.mu.add(4),await on(c),c.pu.set("Unknown"),c.mu.delete(4),await us(c)}(this))})}),this.pu=new Tf(s,i)}}async function us(e){if(jt(e))for(const t of e.gu)await t(!0)}async function on(e){for(const t of e.gu)await t(!1)}function Tc(e,t){const n=S(e);n.wu.has(t.targetId)||(n.wu.set(t.targetId,t),Qi(n)?Gi(n):pe(n).Mo()&&zi(n,t))}function Ic(e,t){const n=S(e),s=pe(n);n.wu.delete(t),s.Mo()&&Ac(n,t),n.wu.size===0&&(s.Mo()?s.Bo():jt(n)&&n.pu.set("Unknown"))}function zi(e,t){e.Iu.Ot(t.targetId),pe(e).Jo(t)}function Ac(e,t){e.Iu.Ot(t),pe(e).Yo(t)}function Gi(e){e.Iu=new Id({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),ie:t=>e.wu.get(t)||null}),pe(e).start(),e.pu.au()}function Qi(e){return jt(e)&&!pe(e).$o()&&e.wu.size>0}function jt(e){return S(e).mu.size===0}function bc(e){e.Iu=void 0}async function Af(e){e.wu.forEach((t,n)=>{zi(e,t)})}async function bf(e,t){bc(e),Qi(e)?(e.pu.fu(t),Gi(e)):e.pu.set("Unknown")}async function Sf(e,t,n){if(e.pu.set("Online"),t instanceof hc&&t.state===2&&t.cause)try{await async function(s,i){const r=i.cause;for(const o of i.targetIds)s.wu.has(o)&&(await s.remoteSyncer.rejectListen(o,r),s.wu.delete(o),s.Iu.removeTarget(o))}(e,t)}catch(s){v("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),s),await Pn(e,s)}else if(t instanceof En?e.Iu.Qt(t):t instanceof uc?e.Iu.Zt(t):e.Iu.Wt(t),!n.isEqual(b.min()))try{const s=await vc(e.localStore);n.compareTo(s)>=0&&await function(i,r){const o=i.Iu.ee(r);return o.targetChanges.forEach((a,c)=>{if(a.resumeToken.approximateByteSize()>0){const u=i.wu.get(c);u&&i.wu.set(c,u.withResumeToken(a.resumeToken,r))}}),o.targetMismatches.forEach(a=>{const c=i.wu.get(a);if(!c)return;i.wu.set(a,c.withResumeToken(Z.EMPTY_BYTE_STRING,c.snapshotVersion)),Ac(i,a);const u=new Lt(c.target,a,1,c.sequenceNumber);zi(i,u)}),i.remoteSyncer.applyRemoteEvent(o)}(e,n)}catch(s){v("RemoteStore","Failed to raise snapshot:",s),await Pn(e,s)}}async function Pn(e,t,n){if(!en(t))throw t;e.mu.add(1),await on(e),e.pu.set("Offline"),n||(n=()=>vc(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{v("RemoteStore","Retrying IndexedDB access"),await n(),e.mu.delete(1),await us(e)})}function Sc(e,t){return t().catch(n=>Pn(e,n,t))}async function hs(e){const t=S(e),n=Ct(t);let s=t._u.length>0?t._u[t._u.length-1].batchId:-1;for(;Cf(t);)try{const i=await hf(t.localStore,s);if(i===null){t._u.length===0&&n.Bo();break}s=i.batchId,_f(t,i)}catch(i){await Pn(t,i)}Cc(t)&&_c(t)}function Cf(e){return jt(e)&&e._u.length<10}function _f(e,t){e._u.push(t);const n=Ct(e);n.Mo()&&n.Xo&&n.tu(t.mutations)}function Cc(e){return jt(e)&&!Ct(e).$o()&&e._u.length>0}function _c(e){Ct(e).start()}async function Df(e){Ct(e).su()}async function Nf(e){const t=Ct(e);for(const n of e._u)t.tu(n.mutations)}async function kf(e,t,n){const s=e._u.shift(),i=ji.from(s,t,n);await Sc(e,()=>e.remoteSyncer.applySuccessfulWrite(i)),await hs(e)}async function Rf(e,t){t&&Ct(e).Xo&&await async function(n,s){if(i=s.code,yd(i)&&i!==f.ABORTED){const r=n._u.shift();Ct(n).Fo(),await Sc(n,()=>n.remoteSyncer.rejectFailedWrite(r.batchId,s)),await hs(n)}var i}(e,t),Cc(e)&&_c(e)}async function to(e,t){const n=S(e);n.asyncQueue.verifyOperationInProgress(),v("RemoteStore","RemoteStore received new credentials");const s=jt(n);n.mu.add(3),await on(n),s&&n.pu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(t),n.mu.delete(3),await us(n)}async function xf(e,t){const n=S(e);t?(n.mu.delete(2),await us(n)):t||(n.mu.add(2),await on(n),n.pu.set("Unknown"))}function pe(e){return e.Tu||(e.Tu=function(t,n,s){const i=S(t);return i.ru(),new vf(n,i.connection,i.authCredentials,i.appCheckCredentials,i.Tt,s)}(e.datastore,e.asyncQueue,{Xr:Af.bind(null,e),no:bf.bind(null,e),Ho:Sf.bind(null,e)}),e.gu.push(async t=>{t?(e.Tu.Fo(),Qi(e)?Gi(e):e.pu.set("Unknown")):(await e.Tu.stop(),bc(e))})),e.Tu}function Ct(e){return e.Eu||(e.Eu=function(t,n,s){const i=S(t);return i.ru(),new wf(n,i.connection,i.authCredentials,i.appCheckCredentials,i.Tt,s)}(e.datastore,e.asyncQueue,{Xr:Df.bind(null,e),no:Rf.bind(null,e),nu:Nf.bind(null,e),eu:kf.bind(null,e)}),e.gu.push(async t=>{t?(e.Eu.Fo(),await hs(e)):(await e.Eu.stop(),e._u.length>0&&(v("RemoteStore",`Stopping write stream with ${e._u.length} pending writes`),e._u=[]))})),e.Eu}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
